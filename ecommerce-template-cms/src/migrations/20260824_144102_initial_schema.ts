...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "categories_images" ADD CONSTRAINT "categories_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "categories_images" ADD CONSTRAINT "categories_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "collections_medusa_id_idx" ON "collections" USING btree ("medusa_id");
  ...
  CREATE INDEX "categories_images_order_idx" ON "categories_images" USING btree ("_order");
  CREATE INDEX "categories_images_parent_id_idx" ON "categories_images" USING btree ("_parent_id");
  CREATE INDEX "categories_images_image_idx" ON "categories_images" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "categories_images" CASCADE;
